...
* @public
*/
google.bookmarkbubble.Bubble.prototype.MOBILE_SAFARI_INSTRUCTIONS = '<span style="color:#fff">Installez ce site sur votre telephone: ' +
        'cliquez sur la flêche puis sur <b>\'Ajoutez à l\'ecran d\'accueil\'</b></span>';
...
* @public
*/
google.bookmarkbubble.Bubble.prototype.MOBILE_SAFARI_OLD_INSTRUCTIONS = '<span style="color:#fff">Installez ce site sur votre telephone: ' +
        'cliquez sur  <b style="font-size:15px">+</b> et ensuite ' +
        '<b>\'Ajoutez à l\'ecran d\'accueil\'</b></span>';
...
* @public
*/
google.bookmarkbubble.Bubble.prototype.ANDROID_BROWSER_INSTRUCTIONS = '<span style="color:#fff">Installez cette web app sur votre telephone: ' +
        'Tapez sur MENU puis sur <b>\'Ajouter un Favori\'</b>. Puis ré-appuyez sur MENU puis sur l\'icône Favoris et enfin longuement sur l\icône du site et <b>\'Raccourci sur la page d\'accueil \'</b></span>';
...
'http://www.fk-agency.com/img/crossbubble.png';
/*'data:image/png;base64,';*/
...
google.bookmarkbubble.Bubble.prototype.build_ = function () {
    ...
    bubbleInner.style.backgroundColor = '#000';
    bubbleInner.style.background = '#000 -webkit-gradient(linear, ' +
    ...
    if (isIpad) {
        ...
        if (this.getAndroidVersion_() >= this.getVersion_(3, 0)) {
            if (this.isPortrait_()) {
                bubbleInner.style.margin = /*'0 0 0 55%'*/'auto';
            } else {
                bubbleInner.style.margin = /*'0 0 0 80%'*/'auto';
            }
        } else {
            if (this.isPortrait_()) {
                bubbleInner.style.margin = /*'0 0 0 20%'*/'auto';
            } else {
                bubbleInner.style.margin = /*'0 0 0 55%'*/'auto';
            }
        }
    ...
    icon.style.width = '57px';
    icon.style.height = '57px';
    icon.style.margin = '5px 7px 3px 5px';
    icon.style.background =
    '#fff url(' + this.getIconUrl_() + ') no-repeat -1px -1px';
   icon.style.WebkitBackgroundSize = '60px';
